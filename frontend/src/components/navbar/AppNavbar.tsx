                ...
                <Navbar.Collapse id="navbar-nav" className='justify-content-end'>
                    <Nav className="mr-auto  align-items-center">
                        ...
                        <Nav.Link as={Link} to="/data"
                                  className={`px-lg-3 ${isActive('/data') ? 'active' : ''}`}>Data</Nav.Link>
                        <Nav.Link as={Link} to="/visualizations"
                                  className={`px-lg-3 ${isActive('/visualizations') ? 'active' : ''}`}>Visualizations</Nav.Link>
                        <Nav.Link as={Link} to="/documents"
                                  className={`ps-lg-3 ${isActive('/documents') ? 'active' : ''}`}>API</Nav.Link>
                    </Nav>
                </Navbar.Collapse>
            </Container>
        </Navbar>
